...
pl.figure(2)
pl.clf()
b = pl.hist(abc.particles[(burnin+100):,:,0].flat,50,alpha=.3,normed=True)
b = pl.hist(abc_true.particles[(burnin+100):,:,0].flat,50,alpha=.3,normed=True)
b = pl.hist(abc_rand.particles[(burnin+100):,:,0].flat,50,alpha=.3,normed=True)
pl.legend(['pda','true','rand'])
pl.show()

pl.figure(3)
pl.clf()
b = pl.hist(abc.particles[(burnin+100):,:,1].flat,50,alpha=.3,normed=True)
b = pl.hist(abc_true.particles[(burnin+100):,:,1].flat,50,alpha=.3,normed=True)
b = pl.hist(abc_rand.particles[(burnin+100):,:,1].flat,50,alpha=.3,normed=True)
pl.legend(['pda','true','rand'])
pl.show()
